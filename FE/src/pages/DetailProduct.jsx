          ...
          console.log(e.target.id);
            if (e.target.id == "add") {
                if (value == "") {
                    ...
                    setValue(1);
                  const res = await  (await axios.post("http://192.168.3.198/cart/add",data)).data
                    if(res.success===true){
                                ...
                                <div className="box-border  ml-[5px] rounded-[8px] p-[24px] my-[20px]">
                                    <div className="flex box-border min-w-0 m-0">
                                        ...
                                        <div className="box-border m-0 w-[50%]">
                                            ...
                                            <div className="font-[400] p-1 mb-[10px]">
                                                Shop: {product.data.seller.fullname}
                                            </div>
                                            <div className="font-[400] p-1 mb-[10px]">
                                                Loại sản phẩm: {product.data.category}{" "}
                                            </div>
                                            <div className="font-[400] p-1 mb-[10px]">Tag: {product.data.tag}</div>
                                            <div className="font-[400] p-1 mb-[10px]">
                                                Mã sản phẩm: {product.data._id}
                                            </div>
                                            ...
                                            <div className="font-[300] p-1 italic">
                                                Mô tả sản phẩm:
                                                <div className="break-words">{product.data.description}</div>
                                            </div>
                                            <form>
                                                <div className="font-[400] text-[#757575] p-1 mb-[10px] flex items-center">
                                                    Số lượng
                                                    ...
                                                    {product.data.quantity} Sản phẩm có sẵn
                                                </div>
                                            </form>
                                            <div className=" flex p-1 mb-[6px] font-bold text-[15px]">
                                                <div>
                                                    <button
                                                        onClick={handleClick}
                                                        id="add"
                                                        className="text-orange-btn relative overflow-visible outline-0 border-[1px] border-orange-btn rounded-[2px] h-[40px] px-[20px] min-w-[70px] max-w-[220px] mr-[15px]">
                                                        Thêm vào giỏ hàng
                                                    </button>
                                                </div>
                                                <div>
                                                    <button
                                                        onClick={handleClick}
                                                        id="navigate"
                                                        className="text-white relative overflow-visible outline-0 bg-orange-btn  h-[40px] px-[20px] min-w-[70px] max-w-[220px]">
                                                        Mua ngay
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <div className=" bg-white flex justify-center ml-[5px] mx-auto box-border  w-[20%] rounded-[0.125rem]">
                                <div className="p-2 ">
                                    ...
                                    <div className="text-[15px] flex mt-2">
                                        ...
                                        <div className="ml-[5px]">Design by Duy</div>
                                    </div>
                                    <div className="text-[15px] flex mt-2">
                                        {" "}
                                        <BorderColorOutlinedIcon color="success" />
                                        <div className="ml-[5px]"> Nhật Duy</div>
                                    </div>
                        ...
                        <div className="flex items-center p-[1.5625rem] h-[auto] rounded-[0.125rem] border-none flex bg-white border-[1px] flex opacity-100 mt-[15px] mb-[1,5rem] w-[97%] mx-auto">
                            <Tooltip title="Account">
                                <Avatar
                                    ...
                                    src={product.data.seller.avt.url}></Avatar>
                            </Tooltip>
                                ...
                                <Link to={`/shop/${product.data.seller._id}`}>
                                    <div className="border-[1px] border-[rgba(0,0,0,.09)] py-[5px] mt-[10px] flex items-center justify-center">
                                        ...
                                        <svg
                                            ...
                                            y="0"
                                            strokeWidth="0"
                                            className="ml-[10px]  text-[rgba(0,0,0,.09)] w-[1em] h-[1em]">
