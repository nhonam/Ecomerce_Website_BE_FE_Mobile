                ...
                <div className="bg-gray-09 border-b-[5px] border-[#ee4d2d] min-h-[600px]">
                    {cart != "" && cart != null ? (
                        <div className="flex flex-col pt-[200px] ml-auto mr-auto w-[1200px] ">
                                ...
                                <div className="pl-[12px] pr-[20px] min-w-[58px] box-border">
                                    <input
                                        ...
                                        onClick={(e) => {
                                            ...
                                            setCart(cart);
                                            cart.map((i) => setTotal((prev) => prev + i.product.price * i.quantity));
                                        ...
                                        checked={!cart.map((i) => isCheck1.includes(i._id)).includes(false)}
                                        className="mr-[20px]"
                                    />
                                </div>
                            ...
                            {Object.values(_.groupBy(cart, "product.seller.fullname")).map((item) => (
                                        ...
                                        <div className="flex items-center overflow-hidden  h-[55px] text-[15px] bg-white mb-[12px] color text-[#888] px-[20px] ">
                                            <div className="pl-[12px] pr-[20px] min-w-[58px] box-border">
                                                <input
                                                    ...
                                                    className="mr-[20px]"
                                                    checked={item.map((i) => isCheck1.includes(i._id)).includes(true)}
                                                />
                                            </div>
                                                ...
                                                <div className="mt-0 px-[16px]">
                                                    <div className="flex items-center text-[14px]">
                                                        ...
                                                        <div className="w-[10.88022%]">
                                                            <span className="m-0 font-light">{index.quantity}</span>
                                                        </div>
                                                        <div className="w-[11.2%]">
                                                            <span className="m-0 font-light">
                                                                {(
                                                                    Number(index.product.price) * Number(index.quantity)
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <button
                                        onClick={async (e) => {
                                            ...
                                            const res = await (
                                                await axios.post("http://192.168.3.198/customer/purchase/buy", {
